...
* No usar censado interno, o data será sesgada hacia arriba con una incorrecta *cummulative distribution function (cdf)*. Si es usado por el laboratorio, re-censorear toda la data al Lc.
